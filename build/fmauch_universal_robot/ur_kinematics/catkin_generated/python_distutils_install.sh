...
echo_and_run cd "/home/bingheng-xie/ur_us/src/fmauch_universal_robot/ur_kinematics"
...
echo_and_run /usr/bin/env \
    ...
    "/home/bingheng-xie/ur_us/src/fmauch_universal_robot/ur_kinematics/setup.py" \
     \
    build --build-base "/home/bingheng-xie/ur_us/build/fmauch_universal_robot/ur_kinematics" \
    install \
    --root="${DESTDIR-/}" \
